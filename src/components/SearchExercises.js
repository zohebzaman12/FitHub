...
const SearchExercises = ({setExercises,bodyPart,setBodyPart,loading,setLoading}) => {
  ...
  return (
    <Stack mt="37px" p="20px" justifyContent="center" alignItems="center" id ='search-exercises'>
